...
<div class="card">
    {if $issueCover}
        <a class="cover" href="{url op="view" path=$issue->getBestIssueId()}" style="margin: 0 auto;">
            <img style="width: 250px;padding-top: 20px;" src="{$issueCover|escape}"{if $issue->getLocalizedCoverImageAltText() != ''} alt="{$issue->getLocalizedCoverImageAltText()|escape}"{/if}>
        </a>
    {/if}
    <div class="card-body">
        <h3>
